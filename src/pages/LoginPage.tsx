    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl shadow-lg p-8 w-full max-w-sm border border-gray-700">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-gray-100 font-medium hover:bg-gray-600 transition-colors"
        >
